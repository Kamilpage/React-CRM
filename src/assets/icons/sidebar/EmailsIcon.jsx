    ...
    return (
        <>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8.63651 10L2.69287 15.4484" stroke={isActive ? '#000' : '#727272'} strokeWidth="1.5" strokeLinecap="round"
                      strokeLinejoin="round"></path>
                <path d="M17.3075 15.4484L11.3638 10" stroke={isActive ? '#000' : '#727272'} strokeWidth="1.5" strokeLinecap="round"
                      strokeLinejoin="round"></path>
            </svg>
        </>
    );
