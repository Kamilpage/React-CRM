        ...
        <>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke={isActive ? '#000' : '#727272'} strokeWidth="1.5" strokeLinecap="round"
                    strokeLinejoin="round"></path>
                <path d="M16.8188 12.4993H12.5V16.818" stroke={isActive ? '#000' : '#727272'} strokeWidth="1.5" strokeLinecap="round"
                      strokeLinejoin="round"></path>
            </svg>
        </>
    );
